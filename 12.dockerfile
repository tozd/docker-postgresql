...
RUN apt-get update -q -q && \
  ...
  apt-get update -q -q && \
  apt-get --no-install-recommends --yes --force-yes install postgresql-12 postgresql-12-postgis-2.4 postgresql-12-postgis-2.4-scripts && \
...
COPY ./postgresql /etc/postgresql/12
